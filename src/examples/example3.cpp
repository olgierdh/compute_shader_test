...
void example3::step( float delta_time_ms )
{
...
void example3::init_render_pass()
{
    // Color attachment
...
void example3::destroy_command_buffer()
{
...
void example3::destroy_pipeline()
{
...
void example3::init_descriptor_set_layout()
{
...
void example3::destroy_descriptor_set_layout()
{
    vkDestroyDescriptorSetLayout( m_vulkan_data.logical_device, m_descriptor_set_layout,
                                  nullptr );
}

void example3::destroy_framebuffers_and_images()
{
...
void example3::init_framebuffers_and_images()
{
...
void example3::init_command_buffer()
{
...
void example3::prepare_vertices()
{
...
void example3::destroy_vertices()
{
...
void example3::init_pipeline()
{
    ...
    VkPipelineShaderStageCreateInfo shader_stage_vertex = {
        ...
        m_vulkan_data.load_shader( "generated/example3.vert.spirv" ),
        "main",
        nullptr};
    ...
    VkPipelineShaderStageCreateInfo shader_stage_fragment = {
        ...
        m_vulkan_data.load_shader( "generated/example3.frag.spirv" ),
        "main",
        nullptr};
...
void example3::create_uniform_buffers()
{
...
void example3::destroy_uniform_buffers()
{
    for ( auto& ub : m_uniform_buffers )
    {
...
void example3::create_descriptor_pool()
{
    ...
    VkDescriptorPoolCreateInfo create_info = {
        ...
        m_vulkan_data.swap_chain.images_count,         1,       &pool_size};
...
#define FOR_STUDENTS_BEGIN
        ...
        vkUpdateDescriptorSets( m_vulkan_data.logical_device, 1, &descriptor_write, 0,
                                nullptr );
#define FOR_STUDENTS_END
    }
}

void example3::destroy_descriptor_sets()
{
    // We don't need to destroy descriptor sets as it will dissapear after the release of
    // the pool
}

void example3::update_unform_buffer( float dt_s, uint32_t current_image )
{
    uniform_buffer ubo{};

    m_rotation += dt_s;

    ubo.model = glm::rotate( glm::mat4( 1.0f ), m_rotation * glm::radians( 90.0f ),
    ...
    ubo.proj = glm::perspective( glm::radians( 45.0f ),
                                 WIDTH / static_cast< float >( HEIGHT ), 0.1f, 10.0f );
